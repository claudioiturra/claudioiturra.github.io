...
r = function() {
$('.img-8').attr('src', (window.devicePixelRatio > 1) ? ((window.devicePixelRatio > 2) ? 'images/madewithsparkle-570-3.png' : 'images/madewithsparkle-380-3.png') : 'images/madewithsparkle-190-3.png');
